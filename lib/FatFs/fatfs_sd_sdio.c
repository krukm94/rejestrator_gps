...
{ 
  ...
  uSdHandle.Init.ClockDiv            = SDMMC_TRANSFER_CLK_DIV;
	...
	{
		serviceUartWriteS("\r\n#error:fatfs_sd_sdio.c(144) SD_IsDetected() != SD_PRESENT");
  ...
  if(HAL_SD_Init(&uSdHandle, &uSdCardInfo) != SD_OK)
	{
		SD_state = MSD_ERROR;
		serviceUartWriteS("\r\n#error:fatfs_sd_sdio.c(160) HAL_SD_Init(&uSdHandle, &uSdCardInfo) != SD_OK "); 
	}
	...
	if (SD_state == MSD_OK) 
	{
		...
		{
			SD_state = MSD_ERROR;
			serviceUartWriteS("\r\n#error:fatfs_sd_sdio(169) HAL_SD_WideBusOperation_Config(&uSdHandle, SDMMC_BUS_WIDE_4B) != SD_OK)");
		}			
		else 
		{
			SD_state = MSD_OK;
...
//  dma_rx_handle.Instance		             = DMA2_Channel4;
//	dma_rx_handle.Init.Request						 = DMA_REQUEST_7;
...
//	{
//		serviceUartWriteS("\r\n#error:datfs_sd_sdio.c(345): HAL_DMA_Init");
//	}
//	
...
//	dma_tx_handle.Instance		             = DMA2_Channel5;
//	dma_tx_handle.Init.Request						 = DMA_REQUEST_7;
...
//	{
//		serviceUartWriteS("\r\n#error:datfs_sd_sdio.c(37): HAL_DMA_Init");
//	}
//	
//	/* Associate the DMA handle */
...
//		HAL_NVIC_SetPriority(SD_DMAx_Rx_IRQn, 1, 1);
//		HAL_NVIC_EnableIRQ(SD_DMAx_Rx_IRQn);
//  
//  /* NVIC configuration for DMA transfer complete interrupt */
//		HAL_NVIC_SetPriority(SD_DMAx_Tx_IRQn, 1, 1);
//		HAL_NVIC_EnableIRQ(SD_DMAx_Tx_IRQn);
//	
//		__HAL_DMA_ENABLE(&dma_rx_handle);
//		__HAL_DMA_ENABLE(&dma_tx_handle);
//	
//		__HAL_DMA_ENABLE_IT(&dma_rx_handle , DMA_IT_TC);
//		__HAL_DMA_ENABLE_IT(&dma_tx_handle , DMA_IT_TC);
}
