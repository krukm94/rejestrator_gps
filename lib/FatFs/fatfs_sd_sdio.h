...
#define SD_DMAx_Tx_CHANNEL                DMA2_Channel5
#define SD_DMAx_Rx_CHANNEL                DMA2_Channel4
#define SD_DMAx_RX_REQUEST								DMA2_REQUEST_7
#define SD_DMAx_TX_REQUEST								DMA2_REQUEST_7 
#define SD_DMAx_Tx_IRQn                   DMA2_Channel5_IRQn
#define SD_DMAx_Rx_IRQn                   DMA2_Channel4_IRQn
#define SD_DMAx_Tx_IRQHandler             DMA2_Channel5_IRQHandler   
